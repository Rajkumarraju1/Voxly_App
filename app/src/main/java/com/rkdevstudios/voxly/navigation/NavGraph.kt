package com.rkdevstudios.voxly.navigation
...
import com.rkdevstudios.voxly.ui.auth.LoginScreen
import com.rkdevstudios.voxly.ui.home.HomeScreen
import com.rkdevstudios.voxly.ui.onboarding.AvatarScreen
import com.rkdevstudios.voxly.ui.onboarding.GenderScreen
import com.rkdevstudios.voxly.ui.onboarding.LanguageScreen
import com.rkdevstudios.voxly.ui.profile.ProfileSetupScreen
import com.rkdevstudios.voxly.ui.splash.SplashScreen
import androidx.compose.foundation.layout.Box
import androidx.compose.ui.platform.LocalContext
import com.rkdevstudios.voxly.ui.call.CallOverlay
...
fun VoxlyNavGraph(
    ...
    val onboardingViewModel: com.rkdevstudios.voxly.ui.viewmodel.OnboardingViewModel = androidx.hilt.navigation.compose.hiltViewModel()
    ...
    Surface(
        ...
        androidx.compose.runtime.LaunchedEffect(homeViewModel) {
            homeViewModel.navigateToActiveCall.collect { call ->
                val intent = android.content.Intent(context, com.rkdevstudios.voxly.ui.call.ActiveCallActivity::class.java).apply {
        ...
        Box(modifier = androidx.compose.ui.Modifier.fillMaxSize()) {
            ...
            composable(Screen.Permission.route) {
                com.rkdevstudios.voxly.ui.onboarding.PermissionScreen(
                    onContinue = {
                        navController.navigate(Screen.Home.route) {
            ...
            composable(Screen.Home.route) {
                ...
                com.rkdevstudios.voxly.ui.main.MainScreen(
            ...
            composable(Screen.Transactions.route) {
                com.rkdevstudios.voxly.ui.wallet.TransactionsScreen(
            ...
            composable(
                ...
                user?.let { currentUser ->
                    com.rkdevstudios.voxly.ui.profile.EditProfileScreen(
            ...
            composable(Screen.PaymentDetails.route) {
                ...
                user?.let { currentUser ->
                    com.rkdevstudios.voxly.ui.payment.PaymentDetailsScreen(
                        user = currentUser,
                        onBack = { navController.popBackStack() },
                        onSave = { updatedUser ->
            ...
            composable(Screen.Earnings.route) {
                val historyViewModel: com.rkdevstudios.voxly.ui.viewmodel.HistoryViewModel = androidx.hilt.navigation.compose.hiltViewModel() // Added
                val user by homeViewModel.currentUser.collectAsState()
                ...
                user?.let { currentUser ->
                    com.rkdevstudios.voxly.ui.speaker.EarningsScreen(
                        user = currentUser,
            ...
            composable(Screen.Wallet.route) {
                com.rkdevstudios.voxly.ui.wallet.WalletScreen(
                    onBackClick = { navController.popBackStack() }
                )
            }
            ...
            composable(Screen.AccountSettings.route) {
                ...
                user?.let { currentUser ->
                    com.rkdevstudios.voxly.ui.profile.AccountSettingsScreen(
                        user = currentUser,
                        onBack = { navController.popBackStack() },
                        onLogout = {
                            homeViewModel.logout()
            ...
            composable(Screen.BecomeListener.route) {
                ...
                com.rkdevstudios.voxly.ui.profile.BecomeListenerScreen(
            ...
            composable(Screen.ListenerForm.route) {
                ...
                user?.let { currentUser ->
                    com.rkdevstudios.voxly.ui.profile.ListenerFormScreen(
            ...
            CallOverlay(
                ...
                onNavigateToIncoming = { state ->
                    val intent = android.content.Intent(context, com.rkdevstudios.voxly.ui.call.IncomingCallActivity::class.java).apply {
                        flags = android.content.Intent.FLAG_ACTIVITY_NEW_TASK or android.content.Intent.FLAG_ACTIVITY_SINGLE_TOP

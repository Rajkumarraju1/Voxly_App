        ...
        firestore.runTransaction { transaction ->
            ...
            if (speakerUser != null) {
                val callTypeEnum = try {
                    com.voxly.app.data.model.CallType.valueOf(call.type.uppercase())
                } catch (e: Exception) {
                    com.voxly.app.data.model.CallType.AUDIO
                }
    ...
    override suspend fun endCallSession(
        ...
        firestore.runTransaction { transaction ->
            ...
            if (speakerEarned > 0) {
                ...
                val speakerTx = com.voxly.app.data.model.Transaction(
                    id = speakerTxRef.id,

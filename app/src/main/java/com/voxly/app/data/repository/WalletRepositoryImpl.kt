...
class WalletRepositoryImpl @Inject constructor(
    ...
    override suspend fun saveTransaction(transaction: com.voxly.app.data.model.Transaction) {
        firestore.collection("transactions").document(transaction.id).set(transaction).await()
    }

    override suspend fun getTransactionsPaged(userId: String, lastDoc: com.google.firebase.firestore.DocumentSnapshot?, limit: Long): Pair<List<com.voxly.app.data.model.Transaction>, com.google.firebase.firestore.DocumentSnapshot?> {
        ...
        try {
            ...
            val transactions = snapshot.toObjects(com.voxly.app.data.model.Transaction::class.java)
    ...
    override fun getTransactions(userId: String): kotlinx.coroutines.flow.Flow<List<com.voxly.app.data.model.Transaction>> = callbackFlow {
        val listener = firestore.collection("transactions")
            ...
            .addSnapshotListener { snapshot, e ->
                ...
                val transactions = snapshot?.toObjects(com.voxly.app.data.model.Transaction::class.java) ?: emptyList()

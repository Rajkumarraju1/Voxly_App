            ...
            VoxlyTheme {
                Surface(color = MaterialTheme.colorScheme.background) {
                    ...
                    LaunchedEffect(callState) {
                        if (callState is com.voxly.app.ui.viewmodel.CallState.Idle) {
                            finish()
                        }
                    }
                    ...
                    IncomingCallScreen(
                        ...
                        onAccept = {
                            lifecycleScope.launch {
                                ...
                                val intent = android.content.Intent(this@IncomingCallActivity, com.voxly.app.ui.call.ActiveCallActivity::class.java).apply {
